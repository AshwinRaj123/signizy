$(document).ready(function() {
    ...
    //check the grid value from the select option and change the grid size based on bootstrap class
    ...
    $("#copy-to-clipboard").on("click", function() {
        ...
        $modal.find(".btn").text("Submit").attr('id','final_submit');
...
//Drag and drop option is done here
...
//This shows a dialog box containing the code for created element, where you can change the id and name of the inpur field
...
//This triggers the modal box with html code of the inpur form
...
$(document).on("click", "#final_submit", function(ev) {
    $.get( "download-form.html", function( data ) {
        $( ".result" ).html( data );
